   ...
   public class ClientHandler implements Runnable	
   {
       ...
       public void run() 
       {
            ...
            try 
            {
                ...
                {
                    ta_chat.append("ข้อความที่ได้รับ: " + message + "\n");
                    data = message.split(":");
                    ...
                    {
                        tellEveryone((data[0] + ":ได้ตัดการเชื่อมต่อ" + ":" + chat));
                        userRemove(data[0]);
                    } 
                    ...
                    {
                        ta_chat.append("เกิดข้อผิดตลาด \n");
                    }
                } 
             } 
             catch (Exception ex) 
             {
                ta_chat.append("การเชื่อมต่อถูกตัดขาด \n");
                ex.printStackTrace();
    ...
    private void b_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_startActionPerformed
        ...
        ta_chat.append("ได้ทำการเปิดเซิฟเวอร์เรียบร้อยแล้ว\n");
